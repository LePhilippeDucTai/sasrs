...
fn parse_header_options(ts: &mut StatementStream) -> Result<(String, bool)> {
...
fn parse_delete_stmt(ts: &mut StatementStream, deletes: &mut Vec<String>) {
...
fn parse_copy_stmt(ts: &mut StatementStream) -> Result<DsOp> {
...
fn parse_exchange_stmt(ts: &mut StatementStream, ops: &mut Vec<DsOp>) -> Result<()> {
...
/// `save m1 m2 ... ;`
fn parse_save_stmt(ts: &mut StatementStream) -> DsOp {
...
fn parse_modify_stmt(ts: &mut StatementStream) -> Result<DsOp> {
